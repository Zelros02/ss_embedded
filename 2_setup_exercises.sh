...
echo "==== 1. Actualizare ci.yml cu Smoke Test și Release ===="
# Rescriem fișierul adăugând noile cerințe
...
echo "==== 2. Salvarea noilor reguli de CI pe main ===="
git add .github/workflows/ci.yml
git commit -m "feat: adaugare Smoke Test si Github Release la tag"
git push origin main

echo "==== 3. Crearea unui eșec intenționat pentru Exercițiul 1 ===="
git checkout -b test-pr-esec

# Introducem o eroare intenționată la finalul fișierului main.cpp
# Dacă fișierul nu există, îl creăm sumar.
mkdir -p src
...
echo "======================================================"
echo "Gata! Acum mergi pe GitHub la repository-ul tău:"
echo "1. Creează un Pull Request din branch-ul 'test-pr-esec' către 'main'."
echo "2. Observă cum verificarea 'Build ESP32 Firmware' sau 'Static Analysis' va eșua, blocând integrarea."
echo "======================================================"
